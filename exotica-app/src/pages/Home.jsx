        ...
        <>
            ...
            <section class="future_sec">
                <div class="container">
                    ...
                    <div className="inner_future">
                        {futures.length > 0 && (
                            <>
                                <div className="future_content">
                                    <div className="heading-title">
                                        <div
                                            dangerouslySetInnerHTML={{ __html: futures[0].text }}
                                        />
                                    </div>
                                    <div className="hero_btn">
                                        <Link
                                ...
                                <div className="share_img">
                                    <img src={`${futures[0].image}`} alt="teech" />
                                </div>
                                <div className="right_futre_img">

                                    <img src={`${futures[0].mainimage}`} alt="teech" />
                                </div>
                            </>
                        )}
                    </div>
                ...
                <div class="container">
                    <div class="inner_expertise">
                        ...
                        <div className="expertise_section">
                            <ul>
                                {cards.map((card) => (
                                    <li className="inner_expert_sec" key={card._id}>
                                        <div className="inner_expert">
                                            <img src={card.image} alt="image" />
                                        </div>
                                        <div className="expertise_cont">
                                            <Link to={card.linkurl}>
                                                {card.linktext}
                                                <img src={card.arrowimage} alt="arrow" />
                                            </Link>
                                        </div>
                                    </li>
                                ))}
            ...
            <section class="why_choose_sec expertise_sec reveal">
                <div class="container">
                    ...
                    <div>
                        {chooseData.length > 0 ? (
                            chooseData.map((chooseItem) => (
                                <div className="inner_why_choose" key={chooseItem._id}>
                                    <div className="heading-title">
                                        <div dangerouslySetInnerHTML={{ __html: chooseItem.heading }} />
                                    </div>
                                    <div className="expertise_inner row">
                                        <div className="col-5">
                                            <div className="expertise_content">
                                                {chooseItem.slides.map((slide, index) => (
                                                    <div className="expertise_box reveal" key={index}>
                                        ...
                                        <div className="col-7">
                                            <div className="expertise_img">
                                                <img src={`/${chooseItem.image}`} alt="Why Choose Us" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
